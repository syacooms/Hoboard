...
<div class="mypage-wrap">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title form-title">병원회원상세정보</h2>
			</div>
		</div>
				...
				<div class="form-wrap">
					...
					<div class="input-wrap clearfix">
						<label for="tel">전화 번호</label> <input type="text" id="tel"
							name="tel" class="textChk" readonly="readonly"
							value="${ user.tel }" />
					</div>
					<div class="input-wrap address-wrap clearfix">
						<label for="">주소</label> <input type="text" id="post_Num"
							name="post_Num" class="textChk address"
							value="${  user.post_Num }" readonly="readonly" /> <input
							type="text" id="address" name="address" class="textChk address"
							value="${ user.address }" readonly="readonly" /> <input
					...
					<c:if test="${ user.auth eq 2 }">
							<div class="input-wrap btn-added clearfix">
								...
								<input type="text" id="logo" name="logo" value="${ b_user.logo }"  readonly="readonly"/>
								<button type="button" class="btn" id="dayBtn">파일첨부</button>
							</div>
							<div class="input-wrap clearfix">
								<label for="homepage">홈페이지</label>
								<input type="text"
									id="homepage" name="homepage" value="${ b_user.homepage }" readonly="readonly" />
							</div>
							<div class="input-wrap clearfix">
								<p>진료시간</p>
